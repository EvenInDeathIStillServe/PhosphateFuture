/obj/item/projectile
	...
	var/list/mob_hit_sound = list('sounds/effects/gore/bullethit2.ogg', 'sounds/effects/gore/bullethit2.ogg') //Sound it makes when it hits a mob. It's a list so you can put multiple hit sounds there.
...
/obj/item/projectile/proc/attack_mob(var/mob/living/target_mob, var/distance, var/miss_modifier=0)
	...
	var/turf/wall/W = get_step(target_mob,src.dir)
	if(istype(W,/turf/wall))
		if(!locate(/obj/effects/blood) in W)
			new /obj/effects/blood(W)
...
/obj/item/projectile/Bump(atom/A as mob|obj|turf|area, forced=0)
	...
	if(istype(A,/obj/structure/table) && pass_flags & PASSTABLE)
		return 0
...
/*
		world << "we movin to [location.return_turf()]"
		world << "we currently is at [loc]"
*/
...
/turf/bullet_act(obj/item/projectile/P)
	playsound(src, 'sounds/weapons/bullet_heavy.ogg', 100, 1)
